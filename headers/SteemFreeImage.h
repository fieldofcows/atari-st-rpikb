...
typedef void (DLL_CALLCONV *FI_INITPROC)(BOOL);
typedef void (DLL_CALLCONV *FI_DEINITPROC)();
typedef FIBITMAP* (DLL_CALLCONV *FI_CONVFROMRAWPROC)(BYTE*,int,int,int,UINT,UINT,UINT,UINT,BOOL);
typedef BOOL (DLL_CALLCONV *FI_SAVEPROC)(FREE_IMAGE_FORMAT,FIBITMAP*,const char *,int);
typedef void (DLL_CALLCONV *FI_FREEPROC)(FIBITMAP*);
typedef BOOL (DLL_CALLCONV *FI_SUPPORTBPPPROC)(FREE_IMAGE_FORMAT,int);
